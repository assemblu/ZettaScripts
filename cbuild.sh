...
wait
cpptesttrace --cpptesttraceOutputFile=/home/emir/dev/cyclonedds-certified/build/cyclonedds.bdf --cpptesttraceProjectName=cyclonedds cmake --build . --config Release --target install
wait
